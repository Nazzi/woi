...
public class OreGeneration implements IWorldGenerator {
	...
	public void generateOverworld(World world, Random random, int x, int z) {
		...
		generateOre(ModBlocks.oreBismuth, world, random, x, z, 2, 10, 5, 10, 150, Blocks.stone);
		generateOre(ModBlocks.oreAdamantine, world, random, x, z, 1, 6, 5, 0, 12, Blocks.stone);
