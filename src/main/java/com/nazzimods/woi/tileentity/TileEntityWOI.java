package com.nazzimods.woi.tileentity;

import java.util.UUID;

import com.nazzimods.woi.network.PacketHandler;
import com.nazzimods.woi.network.message.MessageTileEntityWOI;
...
public class TileEntityWOI extends TileEntity {
	...
	public Packet getDescriptionPacket() {
		return PacketHandler.INSTANCE.getPacketFrom(new MessageTileEntityWOI(this));
	}
}
